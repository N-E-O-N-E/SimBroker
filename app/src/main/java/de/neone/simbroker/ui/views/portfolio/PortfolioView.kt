...
fun PortfolioView(viewModel: SimBrokerViewModel) {
    ...
    val allPortfolioPositions = viewModel.allPortfolioPositions.collectAsState()
    ...
    Column(
        ...
        LazyColumn {
            items(allPortfolioPositions.value) { portfolioPosition ->
                PortfolioCoinListItem(
                    coin = portfolioPosition, onLoad = { },
                )
            }
        }
    }
